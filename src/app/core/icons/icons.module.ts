...
export class IconsModule {
  ...
  constructor(private _domSanitizer: DomSanitizer, private _matIconRegistry: MatIconRegistry) {
    ...
    this._matIconRegistry.addSvgIconSetInNamespace(
      'label_classify',
      this._domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/label-classify.svg'),
    );
    this._matIconRegistry.addSvgIconSetInNamespace(
      'ws',
      this._domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/ws.svg'),
    );
  }
}
